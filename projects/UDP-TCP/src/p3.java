...
public class p3 {
	...
	public static int divSomme(int a){
		int somme=0;
		for (int i = 1; i < a; i++) {
			if(a%i==0)
				somme+=i;
	...
	public static String amicaux(int a ,int b){
		String val;
...
//recive
		...
		System.out.println(n+"+"+m+"= "+(Integer.parseInt(n.trim())+Integer.parseInt(m.trim())));
...
/// p3----p4
		...
		ip.data(Integer.parseInt(n.trim()),Integer.parseInt(m.trim()));
		ip.seta(Integer.parseInt(n.trim()));
		ip.setb(Integer.parseInt(m.trim()));
		String valeur=ip.cube(Integer.parseInt(n.trim()),Integer.parseInt(m.trim())); 		
	//retour
		// p3 ---- p2
    	...
    	sendp22=amicaux(Integer.parseInt(n.trim()),Integer.parseInt(m.trim())).getBytes();
