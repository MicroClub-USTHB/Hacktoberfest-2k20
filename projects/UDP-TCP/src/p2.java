...
//partie p2----p3 UDP
			...
			DatagramPacket reciveP=new DatagramPacket(recive2, recive2.length);
			client.receive(reciveP); 	
			String valeur =new String(reciveP.getData());
		
			reciveP=new DatagramPacket(recive3, recive3.length);
			client.receive(reciveP); 	
			String valeur2=new String(reciveP.getData());
